...
class ParentWindow(Frame):
    def __init__(self, master):
        ...
        #a button for viewing the default webpage
        self.btnSubmit = Button(self.master, text='View Default', width=20, height=1, command=self.defaultHTML)
        self.btnSubmit.grid(row=2, column=1, padx=(0,10), pady=(0,10))
        
        #entry field 
        self.txtEntry = Entry(self.master, font=('Helvetica', 12))
        self.txtEntry.grid(row=1, column=0, padx=(30,15), pady=(10,10), columnspan=3, sticky="ew")
